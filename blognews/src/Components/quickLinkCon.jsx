...
import logoW from './images_Picks/logoNewWhite.png';
          ...
          <React.Fragment>
            <div style={{backgroundColor:'#15006b',width:this.state.width,height:this.state.height,marginTop:"10%"}}>
                 <div style={{marginTop:'6%',position:'absolute',width:this.state.width*0.75,marginLeft:'13%'}}>
                   <Button onClick={() => this.handleShow()} style={{width:(0.2*width),height:this.state.height*0.08,backgroundColor:'white',color:'black',fontSize:this.state.width/55,borderRadius:"35px",marginRight:this.state.width/1.8}}><strong>Contact Us</strong></Button>
