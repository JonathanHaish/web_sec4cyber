...
import VidewStript1 from './videoSF.jsx';
            ...
            <div>
                ...
                <div style={{marginLeft: '10%'}} className="row">     
                  <div style={{marginLeft:"2.5%",marginTop:'3%'}}>        
                    ...
                    <p style={{fontSize:this.props.width/84}}>Sec4Cyber <strong>secures</strong> and <strong>protects</strong> the IoT devices in Consumer IoT<br/> environment <strong>hermetically</strong> without compromising <strong>performance,</strong> by<br/> embedding the security as a part of the operating system.<br/>
