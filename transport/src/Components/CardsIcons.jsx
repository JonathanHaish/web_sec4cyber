...
import ImageI from './Videow/Idia.png';
import ImageAL from './Videow/AI3.png';
import ImageP from './Videow/preform.png';
import ImageT from './Videow/tech.png';
    ...
    render(){
        return(
            <React.Fragment>
                ...
                <Card className="cardS" style={{marginLeft:'3.5%', width:this.props.width*0.221,height:this.props.width/3.7,boxShadow:'4px 4px 4px Lightgrey, 4px 4px 4px black,4px 4px 4px black'}}>
                 <Card.Img src={ImageI} style={{width:'15%', height:'11%',marginLeft:'40%',marginTop:'5%'}} />
                 <Card.Body>
                    <Card.Title style={{marginLeft:"18%",fontSize:this.props.width/60}}><strong>Smooth to R & D</strong></Card.Title>
                    <Card.Text style={{fontSize:this.props.width/88}}>
               ...
               <Card className="cardS" style={{marginLeft:'2%',  width:this.props.width*0.221,height:this.props.width/3.7,boxShadow:'4px 4px 4px Lightgrey, 4px 4px 4px black,4px 4px 4px black' }}>
                 <Card.Img src={ImageAL} style={{width:'15%', height:'11%',marginLeft:'40%',marginTop:'5%'}} />
                 <Card.Body>
                    <Card.Title style={{marginLeft:"15%",fontSize:this.props.width/60}}><strong>Smooth to Legacy <br/><span style={{marginLeft:'20%'}}>Modules</span></strong></Card.Title>
                    <Card.Text style={{fontSize:this.props.width/88}}>
               ...
               <Card className="cardS" style={{marginLeft:'2%',  width:this.props.width*0.221,height:this.props.width/3.7,boxShadow:'4px 4px 4px Lightgrey, 4px 4px 4px black,4px 4px 4px black'}}>
                 ...
                 <Card.Body>
                    <Card.Title style={{marginLeft:"8%",fontSize:this.props.width/60}}><strong>Smooth to Hardware<br/><span style={{marginLeft:'18%'}}> Architecture</span></strong></Card.Title>
                    <Card.Text style={{fontSize:this.props.width/88}}>
               ...
               <Card className="cardS" style={{marginLeft:'2%',  width:this.props.width*0.221,height:this.props.width/3.7,boxShadow:'4px 4px 4px Lightgrey, 4px 4px 4px black,4px 4px 4px black'}}>
                 ...
                 <Card.Body>
                    <Card.Title style={{marginLeft:"18%",fontSize:this.props.width/60}}><strong>NO performance<br/> <span style={{marginLeft:'22%'}}>impacts</span></strong></Card.Title>
                    <Card.Text style={{fontSize:this.props.width/88}}>
