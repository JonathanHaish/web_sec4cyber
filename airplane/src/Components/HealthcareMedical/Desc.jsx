    ...
    render(){
        return(
            <div>
                ...
                <h2 style={{marginLeft: '10%',marginTop:'3%',fontSize:this.state.widthStrip/55}}><strong>Always On. Always Secure. Always High Performance.</strong></h2>
                <div style={{marginLeft: '10%'}} className="row">
                  
                  
                  <div style={{marginLeft:"2.5%",marginTop:'3%'}}>        
                    <h4><strong>Embedded Security Platform</strong></h4>
                    <p style={{fontSize:this.state.width/84}}>Sec4Cyber <strong>secures</strong> and <strong>protects</strong> the Medical Devices in Healthcare<br/> environment <strong>hermetically</strong> without compromising <strong>performance,</strong> by<br/> embedding the security as a part of the operating system.<br/>
...
warning on attack attempts.</p>
                    <h4><strong>Block In-Memory Attacks</strong></h4>
                    <p style={{fontSize:this.state.width/84}}>Performing lightweight Control Flow Integrity (CFI), SafeTrip<br/>
...
programs stay within the expected execution flow.</p>
                    <p style={{fontSize:this.state.width/84}}>SafeGuard device Control Flow Integrity (CFI) doesn’t rely on updates<br/>
...
device. It’s <strong>safe</strong> and <strong>secure</strong> by design.</p>
                    <h4><strong>Self-protect your device</strong></h4>
...
challenged</strong> environments.</p>
                    <p style={{fontSize:this.state.width/84}}><strong>self-protection</strong> against device control loss. Buffer overflows can result<br/>
...
programming (ROP) and (JOP) attacks, which <strong>SafeGuard blocks them.</strong></p>
                    <p style={{fontSize:this.state.width/84}}>After the attack is detected and blocked, SafeGuard provides a detailed<br/>
report of the attack.</p>
                    <h4><strong>Remove the load on your security architect.</strong></h4>
                    ...
                    <h4><strong>Cut Resource Needs</strong></h4>
                    ...
                    <h4><strong>Remove the load on your developers<br/>
Speed Up Time-to-Market.</strong></h4>
                  </div>
                  <div style={{width:this.state.width/3,height:"10%",backgroundColor:"white",position:"absolute",marginTop:"4.4%",marginLeft:"50%"}}></div>
                  <VidewStript1 width={this.state.width*0.39} height={this.state.height/1.3} marginTop="1%" />
                </div>
                <h2 style={{marginLeft: '52%',marginTop:"3%",fontSize:this.state.widthStrip/55}}><strong>Secure your IoMT Network</strong></h2>
                <div style={{marginLeft: '10%'}} className="row">
...
<strong>Prevent zero-day</strong> cyber-attack</p>
                  ...
                  <p style={{fontSize:this.state.width/84}}><strong><BrowserRouter><a href="/SafeTrip/">SafeGaurd</a></BrowserRouter></strong> runs in <strong>resource</strong>
...
<p style={{fontSize:this.state.width/84}}>Actually, <strong>improving endpoint performance, increasing resilience</strong> and <strong>durability<br/>
to 100% secure.</strong><br/>
Sec4Cyber solutions - <strong>SafeGuard deliver end-to-end protection.</strong><br/>
Automatically hardens the vehicle to stop threats, <strong>without impacting automotive<br/>
performance.</strong></p>                  
<p style={{fontSize:this.state.width/84}}><strong>No need</strong> for heavy processing or continual security updates -</p> 
                <h3><strong>Ensures Top Performance</strong></h3>
                 </div>
                 <Image src={ImagePlane} style={{width:this.state.width*0.3,height:this.state.height/2.5,marginTop:"1%",marginLeft:"3%"}}/>
                 </div> 
            </div>
        );
    };
