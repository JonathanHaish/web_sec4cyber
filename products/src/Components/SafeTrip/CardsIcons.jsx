    ...
    render(){
        return(
            <React.Fragment>
                ...
                <Card className="cardS" style={{marginLeft:'4.2555%', width:this.state.width*0.221,height:this.state.width/3.7,boxShadow:'4px 4px 4px Lightgrey, 4px 4px 4px black,4px 4px 4px black'}}>
